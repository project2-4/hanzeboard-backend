...
return [
    ...
    */
    'attributes' => [
        ...
        'status' => 'status',
        'until' => 'tot',
        'student_number' => 'studentennummer',
        'page_name' => 'pagina naam',
        'page_content' => 'pagina content',
        'page_items' => 'pagina items',
        'page_items_deleted' => 'pagina items',
        'page_items_title' => 'pagina item titel',
        'page_items_content' => 'pagina item content',
        'page_items_type' => 'pagina item type',
        'page_items_assignment' => 'pagina item: assignment',
        'page_items_files' => 'pagina item: bestanden',
        'first_name' => 'voornaam',
        'infix' => 'tussenvoegsel',
        'email' => 'email',
